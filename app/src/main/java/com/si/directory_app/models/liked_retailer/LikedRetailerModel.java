...
public class LikedRetailerModel {
    ...
    private String mForgottenPasswordSelector;
    ...
    public String getForgottenPasswordSelector() {
        return mForgottenPasswordSelector;
    }

    public void setForgottenPasswordSelector(String forgottenPasswordSelector) {
